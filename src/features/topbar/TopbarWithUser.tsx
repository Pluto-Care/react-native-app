      ...
      <SignedIn>
        <View className="flex flex-row items-center w-full h-16 px-6 place-items-center">
          <View className="flex-1">
            <Text className={`${twc.text.foreground} text-lg font-bold`}>
              Pluto Health
            </Text>
          </View>
          <View>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <View
                  className={`flex flex-row items-center px-1 py-1 border rounded-full h-min ${twc.border.gray} ${twc.button.opaque}`}>
                  <View className="pl-2.5 pr-3">
                    <Text
                      className={`${twc.text.muted} text-xs font-medium text-right`}>
                  ...
                  <View className="w-6 h-6 rounded-full bg-accent-600">
                    <LinearGradient
                      ...
                      <Text
                        className={`text-xs font-medium text-center ${twc.text.foreground} opacity-50`}>
